...
vtkPolyData *vtkGeoJSONFeature::extractPoint(Json::Value coordinates)
{
    ...
    //OObtain single point data from Json structure to double array
...
vtkPolyData *vtkGeoJSONFeature::extractMultiPoint(Json::Value coordinates)
{
    ...
    {
        vtkPoints *points = vtkPoints::New();//Contain the locations of the points
        vtkCellArray *verts = vtkCellArray::New();//Contain the indices corresponding to the position of the vertices
        ...
        //Update polyData to match the vertices and the corresponding points
...
vtkPolyData *vtkGeoJSONFeature::extractMultiPolygon(Json::Value coordinateArray)
{
    ...
    //Clean polydata to remove replications after appending the polyData
    vtkCleanPolyData *cleanPolyData = vtkCleanPolyData::New();
    cleanPolyData->SetInputConnection(appendPolyDataFilter->GetOutputPort());
    cleanPolyData->Update();
